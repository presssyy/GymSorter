...
public class Login extends AppCompatActivity {
    ...
    Button mLoginBtn;
    TextView mCreateAccountBtn, forgotPasswordLink;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPassword1 = findViewById(R.id.email);
        progressBar = findViewById(R.id.progressBar2);
        fAuth = FirebaseAuth.getInstance();
        mLoginBtn = findViewById(R.id.loginBtn);
        mCreateAccountBtn = findViewById(R.id.createAccount);
        forgotPasswordLink = findViewById(R.id.passwordResetBtn);
        ...
        mLoginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (password1.length() < 6){
                    mPassword1.setError("Password must be 6 characters or more");
                    return;
                }
